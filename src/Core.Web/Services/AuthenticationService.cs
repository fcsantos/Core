...
namespace Core.Web.Services
{
    public interface IAuthenticationService
    {
        ...
        Task<ResponseResult> ChangePassword(ChangePasswordViewModel changePassword);
    ...
    public class AuthenticationService : Service, IAuthenticationService
    {
        ...
        public async Task<ResponseResult> ForgotPassword(ForgotPasswordViewModel forgotPassword)
        {
            ...
            var response = await _httpClient.PostAsync("forgot-my-password", forgotPasswordContent);
        ...
        public async Task<ResponseResult> ResetPassword(ResetPasswordViewModel resetPassword)
        {
            ...
            var response = await _httpClient.PostAsync("reset-password", resetPasswordContent);
        ...
        public async Task<ResponseResult> ChangePassword(ChangePasswordViewModel changePassword)
        {
            var changePasswordContent = GetContent(changePassword);

            var response = await _httpClient.PostAsync("change-password", changePasswordContent);
