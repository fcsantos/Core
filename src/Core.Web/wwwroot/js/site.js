...
$(document).ready(function () {
    ...
    $('#table-criteria-group').DataTable({
        "ordering": true,
        "info": false,
        responsive: true,
        rowReorder: {
    ...
    var type = $("#TypeOfAnswer option:selected").val();
    if (type == "InputText") {
        $('#type-of-answer-inputtext-validationrule').show();
        $('#type-of-answer-inputtext-singleline').show();
        $('#type-of-answer-inputtext-criteriongroup').show();
    } else {
        $('#type-of-answer-inputtext-validationrule').hide();
        $('#type-of-answer-inputtext-singleline').hide();
        $('#type-of-answer-inputtext-criteriongroup').hide();
    }
});
...
$(function () {
    ...
    $("#table-criteria-group").on('click', '#Delete', function () {
        var id = $(this).attr("name");
        var controller = $(this).attr("value");
        console.log(id)
        console.log(controller)
